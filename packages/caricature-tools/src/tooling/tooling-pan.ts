...
export class ZToolingPan implements IZTooling {
   ...
   *
   * @param target -
   *        The target element that contains the bounding rect for dragging.
   * @param context -
   *        The drawing context to update while panning.
   * @param drawing -
   *        The drawing responsible for printing updates.
   * @param transform -
